...
class DualNet(nn.Module):
    def __init__(self ,num_class,  net_type="resnet18"):
        super().__init__()
        self.net1 = PreResNet18(num_classes=num_class)
        self.net2 = PreResNet18(num_classes=num_class)
...
class DualNet_50(nn.Module):
    def __init__(self ,num_class,  net_type="resnet18"):
        super().__init__()
        self.net1 = models.resnet50(pretrained=True)
        self.net1.fc = nn.Linear(2048, num_class)
        self.net2 = models.resnet50(pretrained=True)
        self.net2.fc = nn.Linear(2048, num_class)
