...
def train(epoch, net, ema_net, net2, ema_net2, labeled_trainloader, prob1, prob2, confi_weight1, confi_weight2):
    ...
    for batch_idx, (inputs_x, inputs_x2, labels_x, index, true_labels) in enumerate(labeled_trainloader):
        ...
        if epoch < args.num_epochs - args.start_expand:
            ...
            update_pseudolabel = train_loss1(index, outputs_x, outputs_x, labels_x, epoch, confi_weight1)
        ...
        if epoch < args.num_epochs - args.start_expand:
            ...
            update_pseudolabel = train_loss2(index, outputs_x21, outputs_x21, labels_x2, epoch, confi_weight2)
...
for epoch in range(args.num_epochs):
    ...
    if epoch < warm_up:
        ...
        prob1, targets_list, true_label, confi_weight1 = eval_train(dualnet.net1, rho, 1)
        prob2, _, _, confi_weight2 = eval_train(dualnet.net2, rho, 0)
        pred1 = (prob1  == 1)
